...
public class ModTiers {
    public static final ForgeTier BRONZE = new ForgeTier(2, 550, 5.5f,
    ...
    public static final ForgeTier FLINT = new ForgeTier(1, 198, 7.0f,
    ...
    public static final ForgeTier KATANA_TIER = new ForgeTier(3, 180, 8.0f,
            4.0f, 10, BlockTags.NEEDS_IRON_TOOL, () -> Ingredient.of(Items.IRON_INGOT));
}
