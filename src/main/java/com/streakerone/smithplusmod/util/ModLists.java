...
public class ModLists {
    ...
    private static class Components {
        public static class CompNode {
            ...
            public CompNode(String name, int value) {
                this.name = name;
                this.value = value;
            }
        }
    ...
    public static class Gems extends Components {
    ...
    public static class Alloys extends Components {
    ...
    public static class Metals extends Components {
        protected static class Node extends Components.CompNode {
            protected int meltingPoint;
        ...
        public static void init() {
            ...
            metals.add(new Node("Platinum", 176, 72, 10));
        ...
        private static void defineHeatProperties() {
            for (int i = 0; i < metals.size(); i++) {
                int ticks = meltingTimes.get(i);
                int minFT = calculateMinForgingTemperature(metals.get(i).name);
                int idealFT = calculateMaxForgingTemperature(metals.get(i).name);
                int maxFT = calculateIdealForgingTemperature(metals.get(i).name);
